...
export default function CategoryDirectoryPage() {
  ...
  return (
    <div className="min-h-screen bg-white pb-24 font-sans w-full">
      {/* Top Navbar Header */}
      <div className="bg-[#fcc50b] rounded-b-[30px] shadow-sm mb-4">
        <div className="pt-4 pb-6 px-4 md:max-w-7xl md:mx-auto">
          {/* Top Info Row */}
          ...
          {/* Search Bar */}
          <div className="bg-white rounded-xl h-11 flex items-center px-4 shadow-sm w-full md:max-w-xl md:mx-auto">
